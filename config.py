...
BOT_TOKEN = environ.get("BOT_TOKEN", "7604302137:AAG_sUd_5QS4Ti10b3z76hlLfvh5mzGMu6A")
BOT_OWNER = int(environ.get("BOT_OWNER", "6670233911"))
BOT_USERNAME = environ.get("BOT_USERNAME", "MatXaMuongThanh_BOT")
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002489615288"))
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1002255138114"))
